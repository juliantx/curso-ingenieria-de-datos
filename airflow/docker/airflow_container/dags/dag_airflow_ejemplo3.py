...
# Definición del DAG
dag = DAG(
    'python_bash_execution',
    default_args=default_args,
    description='Un DAG con 3 tareas: PythonOperator, BashOperator y DummyOperator',
...
task2 = BashOperator(
    task_id='task_2',
    bash_command='python /opt/airflow/scripts/postgres_to_kafka.py',
    dag=dag
)
